...
static const int64 MAX_MONEY = 500000000 * COIN; // ShopCoin: maximum of 500Millions coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 4320 / 250; // ShopCoin: 4320 blocks found a day. Priority cutoff is 1 shopcoin day / 250 bytes.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("0444445678901234567890000111222333444555666777888999000000aaaaabbbbbcccccdddddeeeeeff00ff00ff00ff001234567890abcdef0022446688abc89")))
